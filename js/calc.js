...
//Desafio 3
//Evite a inserção de mais de um operador no visor

function adicionar(botao,visor){
...
//Crie uma nova função no formato no formato ArrowFunction que receba um parâmetro e passe para a função eval() realizar o calculo e devolva o resultado no visor
